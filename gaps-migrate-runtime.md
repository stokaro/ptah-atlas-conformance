...
| --- | --- | --- | --- | --- | --- | --- |
| **RED** | **gap** | migrate-runtime | `mariadb/apply-dry-run-stored-state` | seed | Migrating to version 1 from 1 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mariadb_dry_run_1788710667900901000 outside the selected database; us… | #648 |
| **RED** | **gap** | migrate-runtime | `mariadb/apply-state` | apply | Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mariadb_1788710666232602000 outside the selected database; use a conn… | #648 |
| **RED** | **gap** | migrate-runtime | `mariadb/txtar-check-comment-semantics` | apply | Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mariadb_check_comments_1788710669561791000 outside the selected datab… | #648 |
| **RED** | **gap** | migrate-runtime | `mariadb/txtar-check-hidden-statements` | diagnostic | apply output did not contain "one read-only SELECT statement": Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mariadb_check_hidden_1788710671170760000 outside the selected databas… | #964 |
| **RED** | **gap** | migrate-runtime | `mariadb/txtar-check-short-numeric-body` | diagnostic | apply output did not contain "check assertion must be a read-only SELECT statement": Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mariadb_check_numeric_1788710672786261000 outside the selected databa… | #964 |
| **RED** | **gap** | migrate-runtime | `mysql/apply-dry-run-stored-state` | seed | Migrating to version 1 from 1 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mysql_dry_run_1788710658984319000 outside the selected database; use … | #648 |
| **RED** | **gap** | migrate-runtime | `mysql/apply-state` | apply | Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mysql_1788710657079590000 outside the selected database; use a connec… | #648 |
| **RED** | **gap** | migrate-runtime | `mysql/txtar-check-comment-semantics` | apply | Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mysql_check_comments_1788710660776210000 outside the selected databas… | #648 |
| **RED** | **gap** | migrate-runtime | `mysql/txtar-check-hidden-statements` | diagnostic | apply output did not contain "one read-only SELECT statement": Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mysql_check_hidden_1788710662565153000 outside the selected database;… | #964 |
| **RED** | **gap** | migrate-runtime | `mysql/txtar-check-short-numeric-body` | diagnostic | apply output did not contain "check assertion must be a read-only SELECT statement": Migrating to version 2 from 2 pending migrations. Error: error applying migrations: migration 1 cannot run tx-mode file statement 1 because it references database ptah_rt_mysql_check_numeric_1788710664390727000 outside the selected database… | #964 |
