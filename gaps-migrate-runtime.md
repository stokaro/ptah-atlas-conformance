...
| — | ok | migrate-runtime | `goose/hash-validate-differential` | tamper detection | Atlas CE and ptah-compat rejected the same tampered Goose directory with byte-identical stdout/stderr |  |
