...
func AllProbes() []Probe {
	return []Probe{
		...
		CheckpointWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "checkpoint")},
		ProTestWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "pro-test")},
		...
		DesiredStateWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "desired-state")},
		ApplySimulationWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "apply-simulation")},
		SchemaScopeWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "schema-scope")},
		InspectSourceWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "inspect-source")},
		QualifierTxModeWorkflowProbe{FixtureRoot: filepath.Join("testdata", "workflows", "qualifier-txmode")},
	}
}
